...
(function ($) { return $(function () {
    ...
    */
    ...
    var iframe = function (event) {
        ...
        var maxHeight = (_a = window.innerHeight) !== null && _a !== void 0 ? _a : 100;
        var maxWidth = (_b = window.innerWidth) !== null && _b !== void 0 ? _b : 100;
        var height = 400;
        var radius = 10;
        var width = 400;
     ...
     * @param result
     */
    var stancer_iframe = function (result) {
        var $logo = $(document.createElement('div')).addClass('stancer-logo').append(stancer_SVG);
        $backdrop
    ...
    $window
        .on('message', function (e) { return iframe(e); })
