...
namespace Stancer\Scoped\Isolated\Psr\Log\Test;

use Stancer\Scoped\Isolated\Psr\Log\LoggerInterface;
use Stancer\Scoped\Isolated\Psr\Log\LogLevel;
use Stancer\Scoped\Isolated\PHPUnit\Framework\TestCase;
/**
...
abstract class LoggerInterfaceTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('Stancer\\Scoped\\Isolated\\Psr\\Log\\LoggerInterface', $this->getLogger());
    }
    /**
    ...
    public function testObjectCastToString()
    {
        if (\method_exists($this, 'createPartialMock')) {
            $dummy = $this->createPartialMock('Stancer\\Scoped\\Isolated\\Psr\\Log\\Test\\DummyTest', array('__toString'));
        } else {
            $dummy = $this->getMock('Stancer\\Scoped\\Isolated\\Psr\\Log\\Test\\DummyTest', array('__toString'));
        }
