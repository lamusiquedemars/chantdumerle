...
class Config
{
    ...
    protected array $keys = ['pprod' => null, 'ptest' => null, 'sprod' => null, 'stest' => null];
     ...
     */
    #[Stancer\Core\Documentation\FormatProperty(description: 'HTTP "basic" authentication header\'s value', nullable: \false, restricted: \true, type: 'string')]
     ...
     */
    #[Stancer\Core\Documentation\FormatProperty(description: 'Default user agent', nullable: \false, restricted: \true, type: 'string')]
     ...
     */
    #[Stancer\Core\Documentation\FormatProperty(description: 'Public API key', nullable: \false, restricted: \true, type: 'string')]
     ...
     * @throws Stancer\Exceptions\MissingApiKeyException When no key is found.
     */
    #[Stancer\Core\Documentation\FormatProperty(description: 'Secret API key', nullable: \false, restricted: \true, type: 'string')]
     ...
     * Default : 1
     */
    #[Stancer\Core\Documentation\FormatProperty(description: 'API URI', nullable: \false, restricted: \true, type: 'string')]
    public function getUri() : string
    {
        ...
        $params = ['https', $this->getHost(), $this->getPort(), $this->getVersion()->value];
     ...
     */
    #[Stancer\Core\Documentation\FormatProperty(description: 'API version', nullable: \false, type: 'Stancer\\Scoped\\Isolated\\Stancer\\Enum\\ApiVersion')]
     ...
     * @param string[] $keys Authentication keys.
     */
    public static function init(#[\SensitiveParameter] array $keys) : self
    {
        $obj = new static($keys);
     ...
     * @return $this
     */
    public function setKeys(#[\SensitiveParameter] $keys) : self
    {
        if (!\is_array($keys)) {
