...
use Stancer\Scoped\Isolated\Stancer\Core\AbstractObject;
/**
...
{
    public final const ENDPOINT = 'addresses';
    /**
     * @phpstan-var array<string, DataModel>
     */
    protected array $dataModel = ['city' => ['desc' => 'City name', 'type' => self::STRING, 'size' => ['min' => 1, 'max' => 50]], 'country' => ['desc' => 'ISO 3166-1 alpha-3 country code', 'type' => self::STRING, 'size' => ['fixed' => 2]], 'deleted' => ['desc' => 'Is the address deleted?', 'type' => self::BOOLEAN], 'line1' => ['desc' => 'The street number and name, line 1', 'type' => self::STRING, 'size' => ['min' => 1, 'max' => 50]], 'line2' => ['desc' => 'The street number and name, line 2', 'type' => self::STRING, 'size' => ['min' => 1, 'max' => 50]], 'line3' => ['desc' => 'The street number and name, line 3', 'type' => self::STRING, 'size' => ['min' => 1, 'max' => 50]], 'metadata' => ['desc' => 'A json object, with various usefull data', 'type' => self::STRING, 'value' => '{}'], 'state' => ['desc' => 'ISO 3166-2 state or province', 'type' => self::STRING, 'size' => ['min' => 1, 'max' => 3]], 'zipCode' => ['desc' => 'The zip code', 'type' => self::STRING, 'size' => ['min' => 1, 'max' => 16]]];
    /**
    ...
    public function addMetadata(array $newMetadata) : static
    {
        ...
        $currentMetadata = [...$previousMetadata, ...$newMetadata];
    ...
    public function getMetadata() : array
    {
        ...
        $serializedMetadadata = \json_decode($currentMetadata, \true);
