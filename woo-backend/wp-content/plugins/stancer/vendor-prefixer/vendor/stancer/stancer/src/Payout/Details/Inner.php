...
class Inner extends Stancer\Core\AbstractObject
{
     ...
     */
    protected array $dataModel = ['amount' => ['nullable' => \false, 'restricted' => \true, 'type' => self::INTEGER], 'currency' => ['nullable' => \false, 'restricted' => \true, 'type' => self::STRING], 'parent' => ['nullable' => \false, 'exportable' => \false, 'restricted' => \true, 'type' => Stancer\Payout::class], 'type' => ['allowedValues' => ['disputes', 'payments', 'refunds'], 'nullable' => \false, 'exportable' => \false, 'restricted' => \true, 'type' => self::STRING]];
    /**
     * List elements.
     *
    ...
    #[Stancer\Core\Documentation\FormatProperty(description: 'Current resource location', nullable: \false, restricted: \true, type: self::STRING)]
