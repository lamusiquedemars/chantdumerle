...
class Request implements Psr\Http\Message\RequestInterface
{
     ...
     */
    public function __construct(Stancer\Http\Verb\AbstractVerb|string $method, Psr\Http\Message\UriInterface|string $uri, array $headers = [], array|Psr\Http\Message\StreamInterface|string|null $body = null, string $version = '1.1')
    {
