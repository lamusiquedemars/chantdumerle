 ...
 * @internal
 */
#[Stancer\Core\Documentation\AddProperty('created', description: 'Creation date', restricted: \true, type: \DateTimeImmutable::class)]
abstract class AbstractObject implements \JsonSerializable
{
    ...
    #[Stancer\WillChange\PHP8_3\TypedClassConstants]
    public final const FLOAT = 'float';
    #[Stancer\WillChange\PHP8_3\TypedClassConstants]
    public final const INTEGER = 'integer';
    #[Stancer\WillChange\PHP8_3\TypedClassConstants]
    public final const MIXED = 'mixed';
    #[Stancer\WillChange\PHP8_3\TypedClassConstants]
    ...
    public function __construct($id = null)
    {
        ...
        $defaultModel = ['allowedValues' => null, 'coerce' => null, 'exception' => null, 'exportable' => null, 'format' => null, 'list' => \false, 'onlyID' => \false, 'restricted' => \false, 'required' => \false, 'size' => ['fixed' => null, 'min' => null, 'max' => null], 'type' => self::MIXED, 'value' => null];
     ...
     */
    #[Stancer\Core\Documentation\FormatProperty(description: 'Creation date', restricted: \true, type: \DateTimeImmutable::class)]
     ...
     * Return API endpoint.
     */
    #[Stancer\Core\Documentation\FormatProperty(description: 'API endpoint', nullable: \false, restricted: \true, type: self::STRING)]
     ...
     * Return entity name.
     */
    #[Stancer\Core\Documentation\FormatProperty(description: 'Entity name', nullable: \false, restricted: \true, type: self::STRING)]
     ...
     * Return object ID.
     */
    #[Stancer\Core\Documentation\FormatProperty(description: 'Object ID', restricted: \true, type: self::STRING)]
     ...
     */
    #[Stancer\Core\Documentation\FormatProperty(description: 'Entity resource location', nullable: \false, restricted: \true, type: self::STRING)]
    ...
    public function hydrate(array $data) : static
    {
        foreach ($data as $key => $value) {
            ...
            if ($property === 'id') {
                ...
                if (\is_a($model['type'], \BackedEnum::class, \true)) {
        ...
        foreach ($struct as $prop => &$value) {
            ...
            if (\is_object($value)) {
                if (\is_a($value, \BackedEnum::class)) {
                    $value = $value->value;
                } elseif (\in_array($prop, $this->modified, \true) || $value instanceof self && $value->isModified()) {
                    $supp = \false;
                }
     ...
     * @throws Stancer\Exceptions\InvalidArgumentException When asking an unknown property.
     */
    protected function dataModelGetter(string $property, bool $autoPopulate = \true) : mixed
    {
        $model = $this->getModel($property);
        if (!$model) {
            throw new Stancer\Exceptions\InvalidArgumentException(\sprintf('Unknown property "%s"', $property));
    ...
    protected function validateDataModel(string $property, mixed $value) : mixed
    {
        ...
        if (\is_a($model['type'], \BackedEnum::class, \true) && \gettype($value) === 'string') {
