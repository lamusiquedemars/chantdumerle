 ...
 * @internal
 */
#[Stancer\Core\Documentation\AddMethod('setPayment', ['Stancer\\Payment $payment'], '$this', stan: \true)]
class Refund extends Stancer\Core\AbstractObject
{
    ...
    public final const ENDPOINT = 'refunds';
    /**
     * @phpstan-var array<string, DataModel>
     */
    protected array $dataModel = ['amount' => ['desc' => 'Amount to refund', 'exportable' => \true, 'nullable' => \false, 'restricted' => \true, 'size' => ['min' => 50], 'type' => self::INTEGER], 'currency' => ['desc' => 'Processed currency', 'exportable' => \true, 'nullable' => \false, 'restricted' => \true, 'type' => self::STRING], 'dateBank' => ['desc' => 'Delivery date of the funds by the bank', 'restricted' => \true, 'type' => \DateTimeImmutable::class], 'dateRefund' => ['desc' => 'Date when the API sent the refund request to the bank', 'restricted' => \true, 'type' => \DateTimeImmutable::class], 'payment' => ['desc' => 'Refunded payment identifier', 'exportable' => \true, 'nullable' => \false, 'restricted' => \true, 'type' => Stancer\Payment::class], 'status' => ['desc' => 'Refund status', 'restricted' => \true, 'type' => Stancer\Refund\Status::class]];
    /**
