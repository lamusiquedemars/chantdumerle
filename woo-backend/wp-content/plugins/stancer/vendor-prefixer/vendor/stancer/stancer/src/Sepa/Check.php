...
class Check extends Stancer\Core\AbstractObject
{
    ...
    public final const ENDPOINT = 'sepa/check';
    /**
     * @phpstan-var array<string, DataModel>
     */
    protected array $dataModel = ['dateBirth' => ['restricted' => \true, 'type' => self::BOOLEAN], 'response' => ['restricted' => \true, 'size' => ['min' => 2, 'max' => 4], 'type' => self::STRING], 'scoreName' => ['coerce' => Stancer\Core\Type\Helper::INTEGER_TO_PERCENTAGE, 'restricted' => \true, 'type' => self::FLOAT], 'sepa' => ['restricted' => \true, 'type' => Stancer\Sepa::class], 'status' => ['restricted' => \true, 'type' => Stancer\Sepa\Check\Status::class]];
    /**
