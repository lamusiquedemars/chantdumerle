...
class Response implements Psr\Http\Message\ResponseInterface
{
     ...
     */
    public function __construct(protected int $code, Psr\Http\Message\StreamInterface|string|null $body = null, array $headers = [], protected string $protocol = '1.1', protected ?string $reason = null)
    {
