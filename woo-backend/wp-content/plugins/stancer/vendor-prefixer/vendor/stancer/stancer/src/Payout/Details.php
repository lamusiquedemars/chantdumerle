 ...
 * @internal
 */
#[Stancer\Core\Documentation\AddMethod('disputes', ['array<mixed> $terms'], '\\Generator<Stancer\\Dispute>', description: 'List every disputes in the payout.')]
#[Stancer\Core\Documentation\AddMethod('listDisputes', ['array<mixed> $terms'], '\\Generator<Stancer\\Dispute>', description: 'List every disputes in the payout.')]
#[Stancer\Core\Documentation\AddMethod('listDisputes', ['SearchFilters $terms'], '\\Generator<Stancer\\Dispute>', description: 'List every disputes in the payout.', stan: \true)]
#[Stancer\Core\Documentation\AddMethod('payments', ['array<mixed> $terms'], '\\Generator<Stancer\\Payment>', description: 'List every payments in the payout.')]
#[Stancer\Core\Documentation\AddMethod('listPayments', ['array<mixed> $terms'], '\\Generator<Stancer\\Payment>', description: 'List every payments in the payout.')]
#[Stancer\Core\Documentation\AddMethod('listPayments', ['SearchFilters $terms'], '\\Generator<Stancer\\Payment>', description: 'List every payments in the payout.', stan: \true)]
#[Stancer\Core\Documentation\AddMethod('refunds', ['array<mixed> $terms'], '\\Generator<Stancer\\Refund>', description: 'List every refunds in the payout.')]
#[Stancer\Core\Documentation\AddMethod('listRefunds', ['array<mixed> $terms'], '\\Generator<Stancer\\Refund>', description: 'List every refunds in the payout.')]
#[Stancer\Core\Documentation\AddMethod('listRefunds', ['SearchFilters $terms'], '\\Generator<Stancer\\Refund>', description: 'List every refunds in the payout.', stan: \true)]
class Details extends Stancer\Core\AbstractObject
{
    /**
     * @phpstan-var array<string, DataModel>
     */
    protected array $dataModel = ['disputes' => ['desc' => 'Disputes details', 'restricted' => \true, 'type' => Stancer\Payout\Details\Inner::class], 'payments' => ['desc' => 'Payments details', 'restricted' => \true, 'type' => Stancer\Payout\Details\Inner::class], 'refunds' => ['desc' => 'Refunds details', 'restricted' => \true, 'type' => Stancer\Payout\Details\Inner::class]];
    /**
