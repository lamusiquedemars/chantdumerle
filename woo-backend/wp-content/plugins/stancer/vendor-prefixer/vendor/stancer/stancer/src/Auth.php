...
class Auth extends Stancer\Core\AbstractObject
{
     ...
     */
    protected array $dataModel = ['redirectUrl' => ['desc' => 'The redirection URL to start an authentification session', 'restricted' => \true, 'type' => self::STRING], 'returnUrl' => ['desc' => 'The return URL at end of the authentification session', 'size' => ['min' => 1, 'max' => 2048], 'type' => self::STRING], 'status' => ['desc' => 'The authentification status', 'exportable' => \true, 'restricted' => \true, 'type' => Stancer\Auth\Status::class, 'value' => Stancer\Auth\Status::REQUEST]];
    /** @var string[] */
    protected array $modified = ['status'];
    /**
