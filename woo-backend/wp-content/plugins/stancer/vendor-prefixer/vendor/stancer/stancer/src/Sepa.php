...
class Sepa extends Stancer\Core\AbstractObject implements Stancer\Interfaces\PaymentMeansInterface
{
     ...
     */
    #[Stancer\Core\Documentation\FormatProperty(description: 'Formatted IBAN', required: \true, restricted: \true, type: self::STRING)]
     ...
     */
    public function setIban(#[\SensitiveParameter] string $iban) : self
    {
