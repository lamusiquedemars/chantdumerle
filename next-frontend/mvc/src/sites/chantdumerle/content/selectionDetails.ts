...
> = {
  ...
  packs: {
    decouverte: {
      ...
      intro:
        "Une entrée simple pour découvrir un ensemble cohérent, avec les cordes et accessoires essentiels sans multiplier les décisions techniques.",
      emptyText: "Les produits du pack découverte sont en préparation.",
    },
    etude: {
      eyebrow: "Packs",
      title: "Pack étude",
      intro:
        "Un pack pensé pour le travail régulier : stabilité, confort de jeu, accessoires utiles et choix raisonnable pour avancer sans se disperser.",
      emptyText: "Les produits du pack étude sont en préparation.",
    },
    scene: {
      eyebrow: "Packs",
      title: "Pack scène",
      intro:
        "Un pack pour préparer une situation plus exposée, avec davantage de présence sonore et des accessoires choisis pour jouer tout de suite.",
      emptyText: "Les produits du pack scène sont en préparation.",
    },
  },
};
